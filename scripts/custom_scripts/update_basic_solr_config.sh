...
FGS_TARGET="/var/lib/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex/"
...
sed -i 's|/vhosts/fedora/tomcat|/var/lib/tomcat|g' 4-x-utk/foxmlToSolr.xslt
sed -i 's|/vhosts/fedora/tomcat|/var/lib/tomcat|g' 4-x-utk/islandora_transforms/*.xslt
...
sudo chown -hR tomcat:tomcat "$FGS_TARGET"
...
# update file/directory ownership
sudo chown -hR tomcat:tomcat /usr/local/solr/collection1/conf
